...
casual.__cloneFunc = function() {}; (function() {
    ...
    c.prototype.dispatchEvent = function(a) {
        casual.EventManager.dispatchEvent(this,
        a)
    };
    ...
    c.prototype.hitTestObject = function(b, d, e) {
        ...
        if (f && f.width > 0 && f.height > 0) {
            ...
            try {
                ...
                for (b = 0; b < i.length;) {
                    if ((i[b] > 0 || i[b + 1] > 0 || i[b + 2] > 0 || i[b +
                    3] >= e) && (j[b] > 0 || j[b + 1] > 0 || j[b + 2] > 0 || j[b + 3] >= e)) {
                        d = true;
                        break
                    }
                    b += 4
    ...
    var c = function(a) {
        ...
        if (casual.StageEvent.supportTouch()) {
            ...
            casual.delegate(this.__touchHandler, this), false);
    ...
    c.prototype.__mouseHandler = function(a) {
        ...
        this.traceMouseTarget && a.type == "mousemove" &&
    ...
    c.prototype.getFrameNumber = function(a) {
        ...
        for (a = 0; a < this._frames.length; a++) if (b == this._frames[a]) return a +
        1;
        return - 1
    };
    ...
    c.prototype.lineStyle = function(a, b, d, e, f, g) {
        ...
        if (f != undefined) this._context.lineJoin =
        f;
    ...
    c.prototype.beginBitmapFill = function(a, b) {
        b = b || "";
        this.fillStyle = this.createPattern(a,
        b);
        return this
    };
    ...
    c.prototype.drawEllipse = function(a, b, d, e) {
        ...
        this.bezierCurveTo(a - d, b + g, a - f, b + e, a, b + e);
        this.bezierCurveTo(a + f, b + e, a + d, b + g, a + d,
        b);
        this.closePath();
        this.endFill();
        return this
    ...
    c.prototype.setUpState = function(a) {
        this.addFrameAt(new casual.Frame(a, c.state.UP),
        0);
        this.upState = a;
        return this
    };
    ...
    c.prototype.setEnabled = function(a) {
        ...
        if (this.mouseEnabled = this.enabled = a) this.currentFrame ==
        4 && this.gotoAndStop(c.state.UP);
